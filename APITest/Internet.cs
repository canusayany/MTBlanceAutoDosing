namespace WebServiceInfrastructure
{
    ...
    public static class Internet
    {
        ...
        /// <summary>
        /// Checks whether the primary ip address of this instrument or computer has changed.
        /// </summary>
        /// <returns>True, when the ip address has changed.</returns>
        public static bool HasLocalIpAddressChanged
        {
            get
            {
                var currentAddress = ReadLocalIpV4Address();
                if (_localIpv4Address != currentAddress)
                {
                    _localIpv4Address = currentAddress;
                    return true;
                }
